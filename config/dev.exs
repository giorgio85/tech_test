...
config :ukio, UkioWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "Dl4Lp8jJLWr6Ilbi1VlADX4oznkT5HhrYuuzhagZVBANDxdRLqCoFeWn3BuIrL/Q",
  watchers: [
...
config :ukio, UkioWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/ukio_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :ukio, dev_routes: true
